  ...
  module Assert
    ...
    def failure_message(method_sym, block, predicate)
      ...
      if predicate.is_a?(Predicated::Equal) && 
        ...
        # funny -- Ruby 1.9.1 wouldn't find plain "ArrayDiff" even though we're in its module
        left_str, right_str, diff_str = Wrong::Assert::ArrayDiff.compute_and_format(predicate.left, predicate.right)
